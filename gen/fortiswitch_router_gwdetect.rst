...
.. raw:: html
    ...
    <li> <span class="li-head">router_gwdetect</span> - Gwdetect. <span class="li-normal">type: dict</span> </li>
        ...
        <li> <span class="li-head">server</span> - Server address(es). <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: server:address</span> </li>
            <ul class="ul-self">
