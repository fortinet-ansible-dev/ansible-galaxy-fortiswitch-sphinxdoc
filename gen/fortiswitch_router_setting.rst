...
.. raw:: html
    ...
    <li> <span class="li-head">router_setting</span> - Set rib settings. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
        <li> <span class="li-head">filter_list</span> - Route filter list configuration. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: filter_list:id</span> </li>
            <ul class="ul-self">
