...
.. raw:: html
    ...
    <li> <span class="li-head">system_alias_command</span> - Alias command definitions. <span class="li-normal">type: dict</span> </li>
        ...
        <li> <span class="li-head">script_arguments</span> - Optional meta-data and control values for script arguments. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: script_arguments:id</span> </li>
            <ul class="ul-self">
            <li> <span class="li-head">allowed_values</span> - Values to limit this argument to. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: script_arguments:id/allowed_values:value</span> </li>
                <ul class="ul-self">
                <li> <span class="li-head">value</span> - Allowed value. <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
                </ul>
            <li> <span class="li-head">help</span> - A help message for the argument. <span class="li-normal">type: str</span> </li>
            <li> <span class="li-head">id</span> - Argument ID. <span class="li-normal">type: int</span> <span class="li-required">required: true</span> </li>
