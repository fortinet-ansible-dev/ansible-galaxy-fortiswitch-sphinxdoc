...
.. raw:: html
    ...
    <li> <span class="li-head">router_policy</span> - Policy routing configuration. <span class="li-normal">type: dict</span> </li>
        ...
        <li> <span class="li-head">interface</span> - Interface configuration. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: interface:name</span> </li>
            <ul class="ul-self">
        ...
        <li> <span class="li-head">nexthop_group</span> - Nexthop group (ECMP) configuration. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: nexthop_group:name</span> </li>
            <ul class="ul-self">
            <li> <span class="li-head">name</span> - Name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
            <li> <span class="li-head">nexthop</span> - Nexthop configuration. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: nexthop_group:name/nexthop:id</span> </li>
                <ul class="ul-self">
                <li> <span class="li-head">id</span> - Id (1-64). <span class="li-normal">type: int</span> <span class="li-required">required: true</span> </li>
        ...
        <li> <span class="li-head">pbr_map</span> - PBR map configuration. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: pbr_map:name</span> </li>
            <ul class="ul-self">
            <li> <span class="li-head">comments</span> - Description/comments. <span class="li-normal">type: str</span> </li>
            <li> <span class="li-head">name</span> - Name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
