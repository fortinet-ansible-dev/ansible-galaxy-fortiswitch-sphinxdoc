...
.. raw:: html
    ...
    <li> <span class="li-head">user_radius</span> - RADIUS server entry configuration. <span class="li-normal">type: dict</span> </li>
        ...
        <li> <span class="li-head">acct_server</span> - Additional accounting servers. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: acct_server:id</span> </li>
            <ul class="ul-self">
