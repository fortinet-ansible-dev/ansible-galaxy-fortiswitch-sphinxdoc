...
.. raw:: html
    ...
    <li> <span class="li-head">switch_stp_instance</span> - Stp instances. <span class="li-normal">type: dict</span> </li>
        ...
        <li> <span class="li-head">stp_port</span> - Port configuration. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: stp_port:name</span> </li>
            <ul class="ul-self">
            ...
            <li> <span class="li-head">name</span> - Port name. Source switch.interface.name. <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
