...
.. raw:: html
    ...
    <li> <span class="li-head">log_fortianalyzer3_setting</span> - Setting for FortiAnalyzer. <span class="li-normal">type: dict</span> </li>
        ...
        <li> <span class="li-head">upload_option</span> - Enable/disable logging to hard disk and then upload to FortiAnalyzer. <span class="li-normal">type: str</span> <span class="li-normal">choices: store_and_upload, realtime</span> </li>
