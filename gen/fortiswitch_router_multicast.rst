...
.. raw:: html
    ...
    <li> <span class="li-head">router_multicast</span> - Router multicast configuration. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
        <li> <span class="li-head">interface</span> - Pim interfaces. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: interface:name</span> </li>
            <ul class="ul-self">
            ...
            <li> <span class="li-head">multicast_flow</span> - Config acceptable source for multicast group. Source router.multicast-flow.name. <span class="li-normal">type: str</span> </li>
