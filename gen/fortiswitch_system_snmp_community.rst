...
.. raw:: html
    ...
    <li> <span class="li-head">system_snmp_community</span> - SNMP community configuration. <span class="li-normal">type: dict</span> </li>
        <ul class="ul-self">
        <li> <span class="li-head">events</span> - Trap snmp events. <span class="li-normal">type: str</span> <span class="li-normal">choices: cpu-high, mem-low, log-full, intf-ip, ent-conf-change</span> </li>
        <li> <span class="li-head">hosts</span> - Allow hosts configuration. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: hosts:id</span> </li>
            <ul class="ul-self">
        ...
        <li> <span class="li-head">hosts6</span> - Allow hosts configuration for IPv6. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: hosts6:id</span> </li>
            <ul class="ul-self">
