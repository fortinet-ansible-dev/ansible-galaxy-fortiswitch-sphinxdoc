...
.. raw:: html
    ...
    <li> <span class="li-head">system_ntp</span> - Ntp system info configuration. <span class="li-normal">type: dict</span> </li>
        ...
        <li> <span class="li-head">ntpserver</span> - NTP server. <span class="li-normal">type: list</span> <span style="font-family:'Courier New'" class="li-required">member_path: ntpserver:id</span> </li>
            <ul class="ul-self">
            ...
            <li> <span class="li-head">id</span> - Time server ID. <span class="li-normal">type: int</span> <span class="li-required">required: true</span> </li>
